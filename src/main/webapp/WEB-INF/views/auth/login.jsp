...
<!-- Perfect Scrollbar -->
<link type="text/css" href='<c:url value="assets/vendor/perfect-scrollbar.css"></c:url>'
	rel="stylesheet">
...
<body class="layout-login">
	...
	<div class="layout-login__form bg-white" data-perfect-scrollbar>
		<div class="d-flex justify-content-center mt-2 mb-5 navbar-light">
			<a href="index.html" class="navbar-brand" style="min-width: 0"> <img
				class="navbar-brand-icon" src='<c:url value="assets/images/logo.png"></c:url>' width="250"
				alt="Stack">
			</a>
		</div>
		...
		<form action="index.html" novalidate>
			...
			<div class="form-group text-center">
				...
				account? <a class="text-body text-underline" href="signup.html">Sign
					up!</a>
			</div>
		</form>
	</div>
	...
	<!-- Perfect Scrollbar -->
	<script src='<c:url value="assets/vendor/perfect-scrollbar.min.js"></c:url>'></script>

	<!-- DOM Factory -->
	<script src='<c:url value="assets/vendor/dom-factory.js"></c:url>'></script>

	<!-- MDK -->
	<script src='<c:url value="assets/vendor/material-design-kit.js"></c:url>'></script>
